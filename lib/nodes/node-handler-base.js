import { isPrimitiveType, isTypeCompatible, MAX_UINT32_VALUE } from "./shared";
    ...
    switch (input.value.kind) {
      ...
      case 'last-result': {
        ...
        if (!prevOutputs || prevOutputs.length == 0) {
          report('Result of last operation unavailable because the previous block has no outputs');
